...
public class Account 
{
   ...
   {
      availableBalance.sottrai(amount);   //      availableBalance -= amount; // subtract from available balance
      totalBalance.sottrai(amount);       //      totalBalance -= amount; // subtract from total balance
   } // end method debit
